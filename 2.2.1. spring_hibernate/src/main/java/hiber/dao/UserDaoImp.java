...
public class UserDaoImp implements UserDao {
   ...
   public User getUserByModelAndSeries(String model, int series) {
      User result;
      try {
      TypedQuery<User> query = sessionFactory.getCurrentSession().createQuery("SELECT us FROM User us JOIN FETCH us.car aut WHERE aut.model = :carModel AND aut.series = :carSeries", User.class);
